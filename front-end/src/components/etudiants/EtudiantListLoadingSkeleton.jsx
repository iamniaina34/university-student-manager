...
function EtudiantListLoadingSkeletonItem({ width }) {
    return (
        <div className='flex justify-between w-full items-center px-4 py-3 border border-none rounded-lg hover:bg-gray-100 hover:transition-all duration-75 ease-out cursor-default' onClick={() => console.log("You like clicking ?")}>
